...
object UpdateEntryId extends GeneratedEntryId {
  ...
  override val emptyFunctions: EntryId.Functions.Empty = UpdateEntryId.EmptyFunctions
  override val nonEmptyFunctions: EntryId.Functions.NonEmpty = UpdateEntryId.NonEmptyFunctions
