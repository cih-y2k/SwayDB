...
object UpdateEntryId extends GeneratedEntryId {
  ...
  override val emptyAppliedFunctions: EntryId.AppliedFunctions.Empty = UpdateEntryId.EmptyAppliedFunctions
  override val nonEmptyAppliedFunctions: EntryId.AppliedFunctions.NonEmpty = UpdateEntryId.NonEmptyAppliedFunctions
