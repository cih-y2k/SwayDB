...
object GroupEntryId extends GeneratedEntryId {
  ...
  override val emptyFunctions: EntryId.Functions.Empty = GroupEntryId.EmptyFunctions
  override val nonEmptyFunctions: EntryId.Functions.NonEmpty = GroupEntryId.NonEmptyFunctions
