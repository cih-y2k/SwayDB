...
object GroupEntryId extends GeneratedEntryId {
  ...
  override val emptyAppliedFunctions: EntryId.AppliedFunctions.Empty = GroupEntryId.EmptyAppliedFunctions
  override val nonEmptyAppliedFunctions: EntryId.AppliedFunctions.NonEmpty = GroupEntryId.NonEmptyAppliedFunctions
