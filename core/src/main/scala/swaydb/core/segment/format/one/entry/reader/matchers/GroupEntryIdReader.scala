...
import swaydb.core.segment.format.one.entry.reader.matchers.GroupReader._
import swaydb.data.slice.{Reader, Slice}
import scala.util.Try
import swaydb.data.order.KeyOrder

object GroupEntryIdReader {
  ...
  def read(id: Int,
           ...
           nextIndexOffset: Int,
           nextIndexSize: Int,
           previous: Option[Persistent])(implicit order: KeyOrder[Slice[Byte]]): Try[Persistent] =
