...
object PutEntryId extends GeneratedEntryId {
  ...
  override val emptyAppliedFunctions: EntryId.AppliedFunctions.Empty = PutEntryId.EmptyAppliedFunctions
  override val nonEmptyAppliedFunctions: EntryId.AppliedFunctions.NonEmpty = PutEntryId.NonEmptyAppliedFunctions
