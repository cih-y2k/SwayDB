...
object RangeEntryId extends GeneratedEntryId {
  ...
  override val emptyAppliedFunctions: EntryId.AppliedFunctions.Empty = RangeEntryId.EmptyAppliedFunctions
  override val nonEmptyAppliedFunctions: EntryId.AppliedFunctions.NonEmpty = RangeEntryId.NonEmptyAppliedFunctions
