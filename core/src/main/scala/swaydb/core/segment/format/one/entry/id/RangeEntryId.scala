...
object RangeEntryId extends GeneratedEntryId {
  ...
  override val emptyFunctions: EntryId.Functions.Empty = RangeEntryId.EmptyFunctions
  override val nonEmptyFunctions: EntryId.Functions.NonEmpty = RangeEntryId.NonEmptyFunctions
